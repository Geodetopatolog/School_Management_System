...
public interface TeacherRepository extends CrudRepository<Teacher,Long>, PagingAndSortingRepository<Teacher, Long> {
    ...
    @Query("select t from Teacher t where t.name = :queryName and t.surname = :querySurname and t.email = :queryEmail and t.age = :queryAge")
    Optional<Teacher> getTeacherByAllData(@Param("queryName") String name,
